...
function setup() 
{
  ...
  oneStar=createSprite(320,50,20,20);
  oneStar.addImage(starImg);
  oneStar.scale=0.02;

  twoStar=createSprite(50,350,20,20);
  twoStar.addImage(starImg);
  twoStar.scale=0.02;
...
function draw() 
{
  ...
  if(collide(fruit,oneStar,20)==true){
    oneStar.visible=false;
    star_display.changeAnimation("oneStar");
  
  }
  if(collide(fruit,twoStar,40)==true){
